...
RUN apt-get update && apt-get install -y\
 git wget unzip sudo mc tzdata locales openjdk-21-jdk libncurses5:i386 libstdc++6:i386 zlib1g:i386 net-tools nano curl awscli\
 && apt-get clean\
...
ARG commandlinetools_zip_file=commandlinetools-linux-13114758_latest.zip
